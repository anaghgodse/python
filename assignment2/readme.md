Assignment2 task 1:it takes an input from user in variable a then checks the divisibility of the input number by 2 if remainder is 0 number is even else it is odd
